...
const A5 = "Yes, the generator is versatile and can be used to create names for a variety of group types, including clans, teams, and factions. Whether you're forming a competitive team or an epic faction, the tool provides tailored options for every need."
  ...
  <ol className="list-none p-0 inline-flex flex-wrap">
    ...
    <li className="flex items-center">
      <a href="/guild-name-generator" className="hover:underline text-[#343a40] text-xs sm:text-sm md:text-base">Guild Name Generator</a>
    </li>
  </ol>
</nav>
          ...
          <p className="text-center text-[#343a40] text-sm sm:text-base md:text-lg">Gender</p>
            <select
      ...
      <hr /> 
      <div className="w-[80%] mx-auto text-[#343a40] my-[10px] ">
        <div className="py-[20px] flex sm:flex-row flex-col gap-4">
