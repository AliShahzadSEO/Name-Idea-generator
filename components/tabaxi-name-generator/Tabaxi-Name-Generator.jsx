...
const TabaxiNameGenerator = () => {
  ...
  <ol className="list-none p-0 inline-flex flex-wrap">
    ...
    <li className="flex items-center">
      <a href="/tabaxi-name-generator" className="hover:underline text-[#343a40] text-xs sm:text-sm md:text-base">Tabaxi Name Generator</a>
    </li>
  </ol>
</nav>
            ...
            <div class="w-[80%] mx-auto text-[#343a40] my-[30px]">
                <div class="text-center mb-[10px]">
                    <h2 class="sm:text-[36px] text-[24px] font-semibold mb-4">
                    Why Use Our Tabaxi Name Generator?
                    </h2>
                    <p class="sm:text-[16px] text-[18px] ">
