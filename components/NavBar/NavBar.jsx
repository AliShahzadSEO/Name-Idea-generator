          ...
          <div className="flex gap-4">
            ...
            >
              <div className="flex items-center hover:text-[#007bff] gap-[2px] cursor-pointer relative">
                <a href="https://www.nameideagenerator.com/categories/fantasy-and-mythical-creatures">
                  {" "}
              ...
              >
                <li className="hover:text-[#007bff]">
                  <a href="https://www.nameideagenerator.com/demon-name-generator">
                    {" "}
                    Demon Name <br /> Generator{" "}
                  </a>
                </li>
                <li className="hover:text-[#007bff]">
                  <a href="https://www.nameideagenerator.com/tiefling-name-generator">
                    Tiefling Name <br /> Generator
                  </a>
                </li>
                <li className="hover:text-[#007bff]">
                  <a href="https://www.nameideagenerator.com/dragonborn-name-generator">
                    Dragonborn Name <br /> Generator
                  </a>
                </li>
                <li className="hover:text-[#007bff]">
                  <a href="https://www.nameideagenerator.com/orc-name-generator">
            ...
            >
              <div className="flex items-center hover:text-[#007bff] gap-[2px] cursor-pointer relative">
                <a href="https://www.nameideagenerator.com/categories/cultural-and-historical">
                  {" "}
                  <p className="font-medium text-[14px] hover:border-b hover:border-solid">
              ...
              >
                <li className="hover:text-[#007bff]">
                  <a href="https://www.nameideagenerator.com/viking-name-generator">
                    Viking Name <br /> Generator
                  </a>
                </li>
                <li className="hover:text-[#007bff]">
                  <a href="https://www.nameideagenerator.com/russian-name-generator">
                    Russian Name <br /> Generator
                  </a>
                </li>
                <li className="hover:text-[#007bff]">
                  <a href="https://www.nameideagenerator.com/greek-name-generator">
                    Greek Name <br /> Generator
                  </a>
                </li>
                <li className="hover:text-[#007bff]">
                  <a href="https://www.nameideagenerator.com/norse-name-generator">
            ...
            >
              <div className="flex items-center hover:text-[#007bff] gap-[2px] cursor-pointer relative">
                <a href="https://www.nameideagenerator.com/categories/fictional-and-scifi">
                  {" "}
                  <p className="font-medium text-[14px] hover:border-b hover:border-solid">
              ...
              >
                <li className="hover:text-[#007bff]">
                  <a href="https://www.nameideagenerator.com/alien-name-generator">
                    Alien Name <br /> Generator
                  </a>
                </li>
                <li className="hover:text-[#007bff]">
                  <a href="https://www.nameideagenerator.com/island-name-generator">
                    Robot Name <br /> Generator
                  </a>
                </li>
                <li className="hover:text-[#007bff]">
                  <a href="https://www.nameideagenerator.com/saiyan-name-generator">
                    Saiyan Name <br /> Generator
                  </a>
                </li>
                <li className="hover:text-[#007bff]">
                  <a href="https://www.nameideagenerator.com/angel-name-generator">
