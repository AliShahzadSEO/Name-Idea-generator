...
const NorseNameGenerator = () => {
  ...
  <ol className="list-none p-0 inline-flex flex-wrap">
    ...
    <li className="flex items-center">
      <a href="/norse-name-generator" className="hover:underline text-[#343a40] text-xs sm:text-sm md:text-base">Norse Name Generator</a>
    </li>
  </ol>
</nav>
...
export default NorseNameGenerator;
