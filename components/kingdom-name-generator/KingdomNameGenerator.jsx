...
{ name: "Photonhelm", detail: "A citadel of light technology.", status: false, gender: "Futuristic Names", type: "Mythical" },
  ...
  { name: "Velorian Keep", detail: "A grand and elegant keep, known for its high towers and rich history.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Starling Hall", detail: "A majestic hall with a serene view of the stars, a center of noble gatherings.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Silvermere", detail: "A kingdom surrounded by a shimmering lake, home to silver mines and elegant structures.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Luminara Castle", detail: "A glowing castle, known for its radiant lights and intricate architecture.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Whitehaven", detail: "A peaceful and elegant haven, surrounded by white stone walls and pristine landscapes.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Queen's Reach", detail: "A royal kingdom reaching the highest peaks, ruled by a queen of great power.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Dawnspire", detail: "A kingdom that rises with the dawn, bathed in golden light every morning.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Wintercrest", detail: "A snow-covered kingdom with elegant ice palaces and winter celebrations.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Celestine Hold", detail: "A kingdom held by celestial beings, radiating peace and tranquility.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Gildedhall", detail: "A royal hall of gilded elegance, adorned with treasures and ancient artifacts.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Rosewood Castle", detail: "A castle surrounded by a rose garden, with intricate woodwork and royal elegance.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Faeryn Vale", detail: "A magical vale surrounded by enchanting creatures and elegant flora.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Ivorycrest", detail: "A kingdom of ivory towers, known for its pristine beauty and elegance.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Evermore Hall", detail: "A timeless hall that stands as a symbol of lasting grace and royal elegance.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Crystalhaven", detail: "A peaceful haven built with crystal walls, radiating light and tranquility.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Moonrose Keep", detail: "A keep nestled in a valley of moonlit roses, glowing with mystery and elegance.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Thornhill Manor", detail: "A manor perched on a hill surrounded by thorns, known for its elegant architecture.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Goldendale", detail: "A prosperous kingdom, known for its golden fields and royal elegance.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Silverveil", detail: "A kingdom shrouded in silver mists, radiating an aura of mystical elegance.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Dreamspire", detail: "A kingdom known for its dream-like beauty, reaching for the stars in elegant spirals.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Sunshroud Castle", detail: "A castle that is always bathed in sunlight, offering a radiant view and elegance.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Radiantkeep", detail: "A castle of radiant light, symbolizing power and elegance.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Glimmerhold", detail: "A grand castle that shines with the elegance of its past rulers.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Pearlcliff", detail: "A kingdom located on a cliff overlooking the sea, known for its pearl-white palaces.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Halcyon Keep", detail: "A peaceful keep, located in a tranquil valley, embodying elegance and serenity.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Amethyst Vale", detail: "A kingdom surrounded by amethyst fields, shimmering with magical elegance.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Everglow Palace", detail: "A glowing palace that stands eternal in beauty, radiating warmth and elegance.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Whisperwind Hall", detail: "A hall where whispers of the past and winds of grace fill the air.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Solsticekeep", detail: "A keep that marks the turning of the seasons, bathed in the elegance of nature.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Mistycrest", detail: "A kingdom surrounded by mist, with elegant towers rising from the clouds.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Crystalbloom Castle", detail: "A castle where crystal flowers bloom in vibrant colors, symbolizing elegance.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Thaloria", detail: "A kingdom filled with legendary beauty, known for its elegant halls and grand spires.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Duskwind Manor", detail: "A manor where the winds of dusk whisper through the elegant halls.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Mistbrook Keep", detail: "A keep beside a misty brook, with elegant towers that rise from the mist.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Ivoryvale", detail: "A vale of pure ivory, known for its elegance and timeless beauty.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Seraphim Hall", detail: "A hall where angelic beings once gathered, exuding elegance and grace.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Twilightcrest", detail: "A kingdom that exists in the twilight hours, bathed in a soft, elegant glow.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Faircrest", detail: "A fair and elegant kingdom, known for its regal beauty and grandeur.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Jewelton", detail: "A kingdom rich in jewels, known for its elegance and sparkling cities.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Valestrana", detail: "A kingdom of enchanting beauty, with elegant spires rising above rolling hills.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Opalspire", detail: "A kingdom known for its opal towers, shimmering with magical elegance.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Whiteoak", detail: "A peaceful kingdom surrounded by oak trees, bathed in an elegant, tranquil light.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Mistglade Keep", detail: "A keep hidden in a misty glade, known for its beauty and royal elegance.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Celestiala", detail: "A celestial kingdom filled with divine elegance and beauty.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Rosevale", detail: "A vale filled with roses, known for its natural elegance and serene beauty.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Goldenhall", detail: "A hall of pure gold, filled with grandeur and unmatched elegance.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Astralore", detail: "A kingdom known for its celestial alignment and elegant night skies.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Glimmerveil", detail: "A kingdom wrapped in a shimmering veil, full of elegance and mystery.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Moonstone Keep", detail: "A keep surrounded by moonstone, glowing with elegant light.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Emberlace Castle", detail: "A castle adorned with ember lace, exuding fiery elegance and grace.", status: false, gender: "Medieval", type: "Elegant Kingdom Name" },
  { name: "Luminara Sovereignty", detail: "A futuristic kingdom shining with radiant energy, ruling the cosmos.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Astravelle", detail: "A dazzling realm of stars and cosmic wonders, where technology and elegance meet.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Solstice Prime", detail: "A prime hub of galactic power, bathed in perpetual sunlight and advanced technology.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Valtoria Nexus", detail: "A nexus of interstellar connections, with unparalleled elegance in its technological design.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Nebula Isle", detail: "A floating isle surrounded by vibrant nebulae, filled with high-tech elegance and beauty.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Velvetstar", detail: "A sparkling star system known for its luxurious elegance and cosmic glamour.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Celestium Enclave", detail: "An enclave within the stars, combining celestial beauty with advanced futuristic technology.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Lumisolar", detail: "A kingdom powered by solar energy, radiant with technological elegance.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Starlithium", detail: "A kingdom powered by rare starlithium, blending futuristic power with unmatched elegance.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Cybeluxe", detail: "A luxurious kingdom built on cutting-edge cybernetics, exuding futuristic elegance.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Galactic Hall", detail: "The hall of the universe's most advanced civilizations, blending futuristic technology with regal elegance.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Empyreal Tower", detail: "A towering citadel, a symbol of divine elegance, reaching into the stars.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Ethereal City", detail: "A city of ethereal beauty, where elegance and advanced technology coexist in harmony.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Solavion Keep", detail: "A high-tech keep standing at the edge of a distant galaxy, bathed in solar power.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Luxuria Citadel", detail: "A citadel of luxury and innovation, shining with an unmatched futuristic elegance.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Marisol Nexus", detail: "A nexus of cosmic trade, known for its vibrant energy and sleek, elegant design.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Serenovia", detail: "A serene kingdom at the heart of the galaxy, balancing peace with high-tech elegance.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Aetherlux", detail: "A kingdom radiating with aetheric energy, exuding a futuristic aura of elegance and power.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Luminara Arcadia", detail: "An idyllic paradise of light, harmony, and futuristic elegance.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Starveil Sovereign", detail: "A sovereign realm veiled in the mysteries of the stars, with unmatched technological elegance.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Equinox Hall", detail: "A grand hall at the crossroads of time, blending futuristic technology and celestial elegance.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Solara Peak", detail: "A peak of solar energy, glowing brightly with futuristic elegance and power.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Ravellion", detail: "A kingdom built among the stars, known for its innovative design and futuristic elegance.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Nebulon Manor", detail: "A manor set amidst the nebula, radiating elegance through its technological advancements.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Celestoria", detail: "A kingdom bathed in celestial energy, representing the height of futuristic elegance.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Aurelium", detail: "A golden kingdom where innovation and elegance combine, shimmering in radiant light.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Solonova", detail: "A nova-powered kingdom, blending high-tech architecture with timeless elegance.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Stardawn Keep", detail: "A keep rising with the dawn of a new star, filled with technological wonder and elegance.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Veloria Station", detail: "A space station known for its luxurious elegance and advanced technological designs.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Astralspire", detail: "A spiraling tower reaching into the stars, representing elegance and technological brilliance.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Oriona Keep", detail: "A futuristic keep in the heart of the galaxy, shimmering with energy and elegance.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Elysium Nexus", detail: "A heavenly realm at the center of the universe, combining technological grace with celestial beauty.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Aetherlune", detail: "A kingdom illuminated by the light of aether, a symbol of elegance and advanced technology.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Helionspire", detail: "A tower that reaches the solar heavens, glowing with both power and elegance.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Galaxion Keep", detail: "A keep among the stars, combining the forces of technology and elegance.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Opalstar Citadel", detail: "A citadel made of opal, exuding elegance and power from every surface.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Neuronova", detail: "A kingdom of intelligent design, powered by neural networks and radiant elegance.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Velorien Ascendancy", detail: "A kingdom on the rise, glowing with elegance and the power of technological advancement.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Zenithar", detail: "A kingdom at the zenith of technological and elegant evolution.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Vexillon Keep", detail: "A futuristic keep set in the heart of a nebula, known for its elegance and strength.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Xylonis Palace", detail: "A palace surrounded by alien beauty, powered by unmatched technology and elegance.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Celestiala Core", detail: "The core of a celestial empire, filled with light, elegance, and advanced technology.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Ameloria", detail: "A kingdom of great beauty, where futuristic elegance blends seamlessly with the natural world.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Nebulessa Hall", detail: "A hall set in the heart of the nebula, exuding elegance and technological mastery.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Luminaris Sovereign", detail: "A sovereign kingdom that shines brightly across the galaxy, radiating futuristic elegance.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Starlight Vale", detail: "A valley of stars, filled with elegance and technological sophistication.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Quantumlore", detail: "A realm of quantum technology, blending elegance with the power of the universe’s mysteries.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Exalon", detail: "A kingdom of unrivaled elegance, powered by the unknown energy of the cosmos.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Novalys", detail: "A kingdom created from the power of novas, bathed in elegant, cosmic light.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
  { name: "Aetherivus", detail: "A world where aetheric energy flows freely, creating a realm of technological elegance.", status: false, gender: "Futuristic", type: "Elegant Kingdom Name" },
];
