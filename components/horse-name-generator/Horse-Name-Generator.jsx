                ...
                <div className="py-[20px] flex sm:flex-row flex-col gap-4">
                    <div className="sm:w-[50%]">
                        <div className="py-[10px] flex flex-col gap-2">
                            ...
                            <p>
                            Click the <b> "Generate Names"</b> button to produce a list of random horse names. If you don't like the names generated, click the button again to create a new set of names.
                            </p>
                        </div>
                        <div className="py-[10px] flex flex-col gap-2">
                            <h3 className="sm:text-[28px] text-[20px] font-semibold">
                            ...
                            <p>
                            Click on a name to save it right away. Your saved names will appear on the website, which you can easily copy-paste for later use. 
                            </p>
                        </div>
                        <div className="py-[10px] flex flex-col gap-4">
                            ...
                            <p>
                            Review the list of names generated by our tool and select the one that best suits your needs. Choose the name that perfectly aligns with your vision.
                            </p>
                        </div>
                    </div>
